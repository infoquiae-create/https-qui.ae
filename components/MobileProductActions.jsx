...
export default function MobileProductActions({ 
  ...
  const handleWhatsAppContact = () => {
    ...
    const phoneNumber = '971123456789' // Format: country code + number without +
    const message = encodeURIComponent(`Hi, I'm interested in this product (${currency} ${effPrice})`)
    ...
    <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white shadow-2xl z-50 safe-area-bottom">
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <button
          ...
          className="flex items-center justify-center w-14 h-12 bg-green-500 rounded-lg transition-all active:bg-green-600 shadow-md"
        >
          <svg 
            viewBox="0 0 24 24" 

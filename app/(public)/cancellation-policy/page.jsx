  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <p className="text-gray-600 mb-8">Options and timelines for cancelling an order on Qui.ae.</p>

        <div className="space-y-6 bg-white border border-gray-200 rounded-xl p-6">
          <section>
            <h2 className="font-semibold text-gray-900 mb-2">1. Before Shipment</h2>
            <p className="text-gray-700">You can request cancellation before the order ships. Go to My Orders and choose Cancel, or email support@qui.ae with your order ID.</p>
          </section>
          <section>

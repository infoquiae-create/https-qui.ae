...
export default function FAQPage() {
  const faqs = [
    {
      q: 'What is Qui.ae?',
      a: 'Qui.ae is an online marketplace where you can discover and shop top-selling and new products across multiple categories.'
    },
    {
      q: 'How do I track my order?',
      a: 'Go to My Orders from your profile menu. You can view real-time updates for each order placed on Qui.ae.'
    },
    {
    ...
    },
    {
      ...
      a: 'Visit the Support page to find contact options. You can raise a ticket or email us at support@qui.ae.'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <p className="text-gray-600 mb-8">Answers to common questions about shopping on Qui.ae.</p>
